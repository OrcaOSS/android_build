...
ifneq ($(ORCA_BUILD),)
include vendor/orca/config/BoardConfigOrca.mk
endif
...
ifneq ($(ORCA_BUILD),)
ifneq ($(wildcard device/orca/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/orca/sepolicy/common/sepolicy.mk)
endif
endif
